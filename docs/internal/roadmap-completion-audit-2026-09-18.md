...
| v2.2 Stateful agentic QA | `partial` | Capability preflight, bounded state graph validation, actor-bound runtime journey compilation/execution, temporal observers, evidence boundaries and bounded OTLP trace federation exist. CLI/worker lifecycle integration, mutation-to-regression automation and production-grade trace/provenance execution are not yet complete. |
