...
| v0.6 Methodology rigor | `partial` | STRIDE/FMEA/OWASP, risk coverage, oracle safety, oracle calibration and a bounded mutation evidence gate exist. Protected mutation execution at scale, semantic root-cause clustering and independent methodology validation remain open. |
