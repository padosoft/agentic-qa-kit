...
| v2.2 Stateful agentic QA | `partial` | Capability preflight, temporal/stateful journeys, multi-actor context and evidence boundaries exist. A complete state graph, mutation-to-regression automation and production-grade trace federation are not yet complete. |
