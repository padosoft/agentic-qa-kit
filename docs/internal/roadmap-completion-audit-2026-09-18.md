...
| v2.2 Stateful agentic QA | `partial` | Capability preflight, bounded state graph validation, actor-bound runtime journey compilation/execution, CLI/worker lifecycle integration, temporal observers, evidence boundaries and bounded OTLP trace federation exist. Mutation-to-regression automation, journey-to-trace correlation and production-grade trace/provenance execution are not yet complete. |
