...
| v0.6 Methodology rigor | `partial` | STRIDE/FMEA/OWASP, risk coverage, oracle safety and evidence ingestion exist. Formal oracle calibration gold sets, mutation execution at scale, semantic root-cause clustering and independent methodology validation remain open. |
...
6. Complete methodology calibration, mutation-scale execution, load/chaos
   testing, external penetration testing and compliance attestations.
