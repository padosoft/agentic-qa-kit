...
The CI PostgreSQL integration job runs a two-instance contract when a test DSN
is configured; this does not replace production backup, PITR or restore drills.
